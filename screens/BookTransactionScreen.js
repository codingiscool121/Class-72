...
export default class TransactionScreen extends React.Component {
    ...
    handleTransaction=async()=>{
      ...
      .then(doc=>{
        ...
        if(book.BookAvailability === true){
           ...
           alert("Issue The Book", ToastAndroid.SHORT)
        }
        else{
          this.bookReturn();
          alert("Return", ToastAndroid.SHORT)
        }
       alert("Handle Transaction", ToastAndroid.SHORT)
      })
    }
    ...
    initiateBookIssue=async()=>{
      ...
      Alert.alert('Your book has been issued');
      this.setState({
        scannedBookId:"",
        scannedStudentId:"",
      })
    ...
    bookReturn=async()=>{
      ...
      db.collection('Students').doc(this.state.scannedStudentId).update({BooksTaken:firebase.firestore.FieldValue.increment(-1)})
      Alert.alert('Your book has been returned.');
      this.setState({
        scannedBookId:"",
        scannedStudentId:"",
      })
